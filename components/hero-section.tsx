...
export function HeroSection() {
  return (
    ...
    >
      ...
      <div className="hidden sm:block absolute top-1/4 right-0 w-64 sm:w-96 h-64 sm:h-96 bg-[#FFF8F0]/10 rounded-full blur-3xl" />
      <div className="hidden sm:block absolute bottom-1/4 left-0 w-48 sm:w-64 h-48 sm:h-64 bg-[#FFF8F0]/5 rounded-full blur-2xl" />

      <div
        className="absolute inset-0 opacity-[0.02]"
        style={{
          backgroundImage: `linear-gradient(#FFF8F0 1px, transparent 1px), linear-gradient(90deg, #FFF8F0 1px, transparent 1px)`,
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-16 sm:py-32">
        <div className="text-center">
          <div className="inline-flex items-center gap-2 bg-[#FFF8F0]/10 border border-[#FFF8F0]/20 rounded-full px-3 sm:px-4 py-2 mb-6 sm:mb-8">
            <span className="w-2 h-2 bg-[#FFF8F0] rounded-full animate-pulse" />
            <span className="text-xs sm:text-sm text-[#FFF8F0] font-medium">
          ...
          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-8xl font-bold tracking-tight mb-4 sm:mb-6">
            ...
            <br />
            <span className="text-[#FFF8F0]">TRANSFORMATION</span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4 w-full px-4 sm:px-0">
            <Button
              asChild
              size="lg"
              className="w-full sm:w-auto bg-[#F5ECD7] hover:bg-[#F5ECD7]/90 text-black font-bold text-base sm:text-lg px-6 sm:px-8 py-4 sm:py-6 h-auto"
            >
              <Link href="#pricing">
                Start Your Journey
            ...
            <Button
              ...
              variant="outline"
              size="lg"
              className="w-full sm:w-auto border-border hover:border-[#FFF8F0] hover:text-[#FFF8F0] font-semibold text-base sm:text-lg px-6 sm:px-8 py-4 sm:py-6 h-auto"
            >
          ...
          <div className="grid grid-cols-3 gap-4 sm:gap-8 mt-12 sm:mt-20 max-w-3xl mx-auto px-2">
            <div className="text-center">
              <div className="text-2xl sm:text-3xl md:text-4xl font-bold text-[#FFF8F0]">4.3</div>
      ...
      <div className="hidden sm:block absolute bottom-6 sm:bottom-8 left-1/2 -translate-x-1/2">
        <div className="w-6 h-10 border-2 border-muted-foreground/30 rounded-full flex justify-center">
          <div className="w-1.5 h-3 bg-[#FFF8F0] rounded-full mt-2 animate-bounce" />
        </div>
      </div>
    </section>
  )
