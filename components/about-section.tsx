        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold mt-4 mb-6 text-balance">
              ...
              <span className="text-[#FFF8F0]">Fitness</span>
            </h2>
            ...
            <div className="flex items-center gap-4 p-4 bg-secondary rounded-lg mb-8">
              <div className="flex gap-1">
                {[...Array(4)].map((_, i) => (
                  <Star key={i} className="w-5 h-5 fill-[#FFF8F0] text-[#FFF8F0]" />
                ))}
                <Star className="w-5 h-5 fill-[#FFF8F0]/30 text-[#FFF8F0]" />
              </div>
              <div>
              ...
              {features.map((feature) => (
                <div key={feature.title} className="flex gap-4">
                  <div className="w-12 h-12 bg-[#FFF8F0]/10 rounded-lg flex items-center justify-center flex-shrink-0">
                    <feature.icon className="w-6 h-6 text-[#FFF8F0]" />
                  </div>
                  <div>
          ...
          <div className="relative mt-8 lg:mt-0">
            <div className="aspect-square bg-gradient-to-br from-secondary to-background rounded-2xl overflow-hidden relative max-w-md mx-auto lg:max-w-none">
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="text-center">
                  <div className="w-24 sm:w-32 h-24 sm:h-32 mx-auto mb-4 sm:mb-6 bg-[#FFF8F0]/20 rounded-full flex items-center justify-center">
                    <Dumbbell className="w-12 sm:w-16 h-12 sm:h-16 text-[#FFF8F0]" />
                  </div>
              ...
              <div className="absolute -bottom-4 -right-4 w-24 sm:w-32 h-24 sm:h-32 bg-[#F5ECD7] rounded-2xl -z-10" />
            </div>
            ...
            <div className="absolute -bottom-4 sm:-bottom-6 left-0 sm:-left-6 bg-card border border-border rounded-xl p-3 sm:p-4 shadow-xl">
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 bg-[#F5ECD7] rounded-full flex items-center justify-center">
                  <Award className="w-5 h-5 text-black" />
                </div>
                <div>
                  <p className="font-bold text-foreground">Since 2018</p>
                  <p className="text-xs text-muted-foreground">Serving Beylikduzu</p>
                </div>
              </div>
            </div>
          </div>
